...
public class MessageHolders {
    ...
    protected int getViewType(Object item, String senderId) {
        ...
        if (item instanceof IMessage) {
            ...
            isOutcoming = String.valueOf(message.getSender()).contentEquals(senderId);
    ...
    public abstract static class BaseIncomingMessageViewHolder<MESSAGE extends IMessage>
        ...
        public void onBind(MESSAGE message) {
            if (time != null) {
                time.setText(DateFormatter.format(message.getCreationDate(), DateFormatter.Template.TIME));
            }
